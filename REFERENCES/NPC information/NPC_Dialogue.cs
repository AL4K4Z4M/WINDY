...
public class DialogueHandler : MonoBehaviour
{
	...
	public void InitializeDialogue(DialogueContainer dialogueContainer, bool enableDialogueBehaviour = true, string entryNodeLabel = "ENTRY")
	{
		...
		if (npc != null && npc.Avatar.Animation.TimeSinceSitEnd < 0.5f && enableDialogueBehaviour)
		{
			StartCoroutine(Wait());
		}
		else
		...
		IEnumerator Wait()
		{
			yield return new WaitForSeconds(0.5f - npc.Avatar.Animation.TimeSinceSitEnd);
			Open();
		}
	}
