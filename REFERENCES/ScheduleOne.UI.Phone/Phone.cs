...
public class Phone : PlayerSingleton<Phone>
{
	...
	protected virtual void Update()
	{
		...
		if (!GameInput.IsTyping && !Singleton<PauseMenu>.Instance.IsPaused && (PlayerSingleton<PlayerCamera>.Instance.activeUIElementCount == 0 || IsOpen) && !Player.Local.IsInVehicle && GameInput.GetButtonDown(GameInput.ButtonCode.ToggleFlashlight))
		{
			ToggleFlashlight();
		}
